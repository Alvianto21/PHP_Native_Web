			...
			<tbody>
				...
				foreach ($articles as $article): ?>
					<tr>
						...
						<td><img src="<?php echo htmlspecialchars($article['photo_cover']); ?>" alt="<?php echo htmlspecialchars($article['slug']); ?>" class="object-fit-md-contain" sizes="200" height="300"></td>
